  ...
  setElements(): void {
    ...
    this.$container.innerHTML = `
      <div class=${compStyle.about__content}>
        ...
        <p>
          대기업 글로벌 웹사이트 구축/운영 프로젝트 경험을 통해 다국어, 반응형, 웹접근성 대응 역량을 쌓았으며,
        ...
        <p>
          ...
          퍼블리셔로 전향한 이후 4년 반 동안 꾸준한 자기 역량계발을 통해 JavaScript 개발자로까지 성장했고, 현재는 JavaScript의 코어 개념과 더불어 React, TypeScript 등의 최신 FE 기술을 학습하고 있습니다.
        ...
        <div class=${compStyle.about__detail}>
          ...
          <dl class=${compStyle['about__detail-skills']}>
            ...
            <div>
              <dt>TypeScript</dt>
              <dd><em style="width:35%"><span>35%</span></em></dd>
            </div>
          </dl>
        </div>
      </div>
